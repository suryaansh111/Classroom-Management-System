 ...
 * 
 */
public class scene_AdminLogin {
	/**
	 * @param window The Primary Stage of the Frontend GUI
	 * @return The Scene for Admin Login Page
	 */
	public static Scene getScene(Stage window)
	{
        ...
        Text welc = new Text("Admin Login");
        ...
        Label req = new Label("Accept/Reject Student Requests");
        grid.add(req, 0, 9);
        Button reqsButton = new Button("View Requests");
        grid.add(reqsButton, 1, 9);
        reqsButton.setOnAction(e -> window.setScene(scene_viewrequest.getScene(window)));
